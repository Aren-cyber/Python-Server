...
class Records(db.Model):
    ...
    rtime = db.Column(
        db.DateTime(timezone=False), server_default=func.current_timestamp()
    )
...
class Devices(db.Model):
    ...
    device_type = db.Column(
        db.Integer, ForeignKey("types.id", ondelete="CASCADE"), nullable=False
    )
...
class Doors(db.Model):
    ...
    # device_id = db.Column(
    #     db.Integer, ForeignKey("devices.device_id", ondelete="CASCADE"), nullable=False
    # )
    device_id = db.Column(
